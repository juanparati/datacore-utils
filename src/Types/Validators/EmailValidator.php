 ...
 */
class EmailValidator extends RegexValidator implements ValidatorContract
{

    /**
     * Regular expression used for test e-mail addresses.
     *
    ...
    {
        return parent::__invoke($data, static::EMAIL_REGEX);
    }
}